$(function(){  
	...
	$('.work-list > li > a').click(function(){
		...
		$(this).siblings('.details').load(href, function(data) {
			...
			$('.modal .modal-content').append('<div class="nav"><a href="#" class="prev off">prev</a><span>Item <em>1</em> of <strong>'+ total + '</strong></span><a href="#" class="next">next</a>');
	...
	$('.modal .nav a').live('click', function(){
